...
$(function () {
    ...
    function pintarDetalle(d) {
        ...
        pintarSeccion($("#detCertificados"), d.certificados, 3, function (x) {
            return trFecha(x.fecha_vencimiento) + "<td>" + AX.enlaceProducto("ssl", x.id, x.nombre_dominio) + "</td>" +
                   "<td>" + AX.escaparHtml(x.proveedor) + "</td>" +
        ...
        pintarSeccion($("#detHistorial"), d.historial, 5, function (x) {
            return trFecha(x.fecha) + "<td>" + AX.formatearFecha(x.fecha) + "</td>" +
        ...
        // Virtual Hosts.
        pintarSeccion($("#detVirtualHosts"), d.virtual_hosts, 7, function (x) {
            ...
            return "<tr><td>" + AX.escaparHtml(x.aplicacion) + "</td>" +
        ...
        pintarSeccion($("#detLogs"), d.logs, 5, function (x) {
            return trFecha(x.fecha_evento) + "<td>" + AX.formatearFecha(x.fecha_evento) + "</td>" +
        ...
        pintarSeccion($("#detNotas"), d.notas, 4, function (x) {
            var f = x.fecha ? String(x.fecha).substring(0, 10) : "";
            var claseFila = critClaseFila(x.criticidad);
            return '<tr data-fecha="' + AX.escaparHtml(f) + '"' + claseFila + ">" +
    ...
    // detalle si estaba abierto; si no, el listado).
