// =====================================================================
//  AXISTENCE - Sockets del modulo Proveedores.
//
//  Reemite a la sala "proveedores" los cambios que publica PHP, para que el
...
//  emitir(io, evento, data) }. Espejo de ./clientes.js.
// =====================================================================

const NOMBRE = 'proveedores';
...
const EVENTOS = ['proveedor:creado', 'proveedor:actualizado', 'proveedor:eliminado'];
