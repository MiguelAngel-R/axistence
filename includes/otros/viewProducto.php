<?php
/* ---------------------------------------------------------------------
   Modulo: Otros productos - Vista de detalle (viewProducto).
   Muestra el producto generico con su informacion relacionada en tabs:
   Clientes (N:N), Campos adicionales (clave-valor) y Notas.
   Lo rellena otros.js desde endpoints/otros/ver.php.
   --------------------------------------------------------------------- */
$tabs = [
    ['id' => 'clientes',  'label' => 'Clientes',           'icon' => 'bi-people',       'tbody' => 'detClientes',  'cols' => ['Nombre / Razon social', 'Identificacion', 'Estado']],
    ['id' => 'atributos', 'label' => 'Campos adicionales',  'icon' => 'bi-ui-checks',    'tbody' => 'detAtributos', 'cols' => ['Campo', 'Valor']],
    ...
    <div class="detalle">
        ...
        <div class="detalle__head">
            <div class="detalle__head-left">
                ...
                <div>
                    <span class="detalle__eyebrow" id="detTipo">Producto</span>
        ...
        <section class="detalle__seccion">
            ...
            <dl class="detalle__grid">
                <div><dt>Tipo de producto</dt><dd id="detTipoProducto">—</dd></div>
